...
class GTSAM_UNSTABLE_EXPORT Pose4DoF : public LieGroup<Pose4DoF, 4> {
 ...
 public:
  ...
  Pose4DoF(const double x, const double y, const double z, const double yaw,
           const double pitch, const double roll);
  Pose4DoF(const Pose2& pose, const double z);
  Pose4DoF(const Pose2& pose, const double z, const double pitch,
           const double roll);
  ...
  // From ChatGPT
  Pose4DoF retract(const Vector& v, OptionalJacobian<4, 4> Horigin,
                   OptionalJacobian<4, 4> Hv) const;

  Vector localCoordinates(const Pose4DoF& p2, OptionalJacobian<4, 4> Horigin,
  ...
  Pose4DoF compose(const Pose4DoF& p2, OptionalJacobian<4, 4> H1 = {},
   ...
   */
  Pose4DoF between(const Pose4DoF& p2, OptionalJacobian<4, 4> H1 = {},
                   OptionalJacobian<4, 4> H2 = {}) const;
  ...
  Point3 transformTo(const Point3& point, OptionalJacobian<3, 4> Hpose = {},
...
struct traits<Pose4DoF> : public internal::LieGroup<Pose4DoF> {
  ...
  static Pose4DoF Between(const Pose4DoF& g, const Pose4DoF& h,
                          OptionalJacobian<4, 4> H1 = {},
                          OptionalJacobian<4, 4> H2 = {}) {
