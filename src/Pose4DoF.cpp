...
/* ************************************************************************* */
Pose4DoF::Pose4DoF(const double x, const double y, const double z,
                   const double theta)
...
/* ************************************************************************* */
Pose4DoF::Pose4DoF(const Pose2& pose, const double z, const double pitch,
                   const double roll)
...
/* ************************************************************************* */
// NOTE(hlim) In PGO, this function is not used
Pose4DoF Pose4DoF::compose(const Pose4DoF& p2, OptionalJacobian<4, 4> H1,
...
/* ************************************************************************* */
Pose4DoF Pose4DoF::between(const Pose4DoF& p2, OptionalJacobian<4, 4> H1,
                           OptionalJacobian<4, 4> H2) const {
...
Point3 Pose4DoF::transformTo(const Point3& point, OptionalJacobian<3, 4> Hpose,
  ...
  gtsam::Point3 relative_point(point.x() - t.x(), point.y() - t.y(),
                               point.z() - z);
...
Pose4DoF Pose4DoF::retract(const Vector& v, OptionalJacobian<4, 4> Horigin,
